...
#define DELTA_DEBUG_LINE(StartLocation, EndLocation) \
  DELTA_INTERNAL_DEBUG_LINE(StartLocation, EndLocation, true)

#define DELTA_DEBUG_LINE_ONE_FRAME(StartLocation, EndLocation) \
  DELTA_INTERNAL_DEBUG_LINE(StartLocation, EndLocation, false)
